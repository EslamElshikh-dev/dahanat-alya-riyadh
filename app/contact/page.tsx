      ...
      <section className="section-space">
        <div className="container-shell grid gap-10 lg:grid-cols-[.9fr_1.1fr]">
          ...
          <div className="grid gap-4 sm:grid-cols-2" data-reveal="up">
            ...
            <a href={site.mapsUrl} target="_blank" rel="noreferrer" className="feature-card rounded-[24px] border border-[#17201c]/8 bg-white p-7"><span className="grid size-12 place-items-center rounded-[15px] bg-[#f3eadb] text-[#9a6928]"><MapPin className="size-6" /></span><p className="mt-8 text-sm font-bold text-[#7a837e]">نطاق الخدمة</p><p className="mt-2 text-xl font-black">{site.coverage}</p></a>
